...
3. Create a google calendar with TA names as events, get the calendar ID(See https://developers.google.com/calendar/quickstart/python), copy the credentials.json file to your workin directory and do the following:
